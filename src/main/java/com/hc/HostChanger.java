...
import com.hc.domain.ImageDomain;
...
//	public static Color selectColor = new Color(0xEE, 0xFA, 0xE6);
	...
	public static Color unSelectColor = Color.LIGHT_GRAY;
	...
	public HostChanger() {
		...
		jOpenBtn.setToolTipText("Open HOSTS file");
	...
	public static ImageIcon string2Image(String text) {		
		...
		graphic.setFont(new Font(null, Font.ITALIC,12));
