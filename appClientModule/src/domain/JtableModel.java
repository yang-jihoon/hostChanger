		...
		if (columnIndex == 1) {	
			...
			if (!orgString.equals((String)getValueAt(rowIndex,columnIndex))) {
				...
				if (columnIndex == 3) {
					...
					if (!hostGroup.contains((String)object)){
